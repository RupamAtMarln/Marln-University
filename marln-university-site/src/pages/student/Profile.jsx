          ...
          <div className="col-span-2 flex flex-col gap-8">
            ...
            <form className="bg-white rounded-xl shadow p-6 grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
              ...
              <div>
                ...
                <input type="text" name="program" value={profile.program} onChange={handleChange} className="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Year</label>
                <input type="text" name="year" value={profile.year} onChange={handleChange} className="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3" />
              </div>
              <div>
            ...
            <div className="bg-white rounded-xl shadow p-6 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500"><BarChart2 size={16}/> Pending Assignments: <span className="font-medium text-yellow-700">{profile.stats.assignments}</span></div>
              <div className="flex items-center gap-2 text-sm text-gray-500"><BarChart2 size={16}/> Activity Score: <span className="font-medium text-green-700">{profile.stats.activity}%</span></div>
