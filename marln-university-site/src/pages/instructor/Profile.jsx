          ...
          <div className="col-span-2 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow p-6 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500"><BarChart2 size={16}/> Courses Taught: <span className="font-medium text-blue-700">{profile.stats.courses}</span></div>
